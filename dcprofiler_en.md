...
  Meaning cache hit ratio of LLC (Last-Level Cache)
...
  API Server provides RESTful API and controls the operation of Continuous Profiler and On-demand Profiler through Config Manager.
...
- Zeppelin
   
  Dash Board, and interacts with Presto to provide an interactive SQL Query to the user and display it graphically.
